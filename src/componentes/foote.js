  ...
  return (
    <footer className="mt-5 bg-dark text-light p-4 footer">
      <Container fluid className="text-center">
        <div className="mb-3">
          <a
            href="https://www.facebook.com/profile.php?id=100094886682039"
            target="https://www.facebook.com/profile.php?id=100094886682039"
          ...
          <a
            href="https://www.instagram.com/amzreview3/"
            target="https://www.instagram.com/amzreview3/"
