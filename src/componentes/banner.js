    ...
    <>
      <Container fluid className="fondo">
       <Row>
          <Col sm={6} >
            <h1 >AMZ Review</h1>
            <h2> Descubri las mejores Review de Amazon... </h2>
          ...
          <Col  sm={6} className="d-flex align-items-center justify-content-center">
            ...
            <Image src={imgLogo} alt={imgLogo} className="img-fluid animate__animated animate__flash animate__slower animate__infinite" />
